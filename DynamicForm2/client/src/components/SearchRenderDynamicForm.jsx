...
const SearchRenderDynamicForm = () => {
  ...
  const handleGetProfile = () => {
    if (!profileInput.trim()) return alert("Enter a Dynamic Form Name");
    setSelectedProfile(profileInput.trim());
    loadForm(profileInput.trim());
  };
  // Save while typing
...
export default SearchRenderDynamicForm;
